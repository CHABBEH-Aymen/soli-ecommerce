...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div id="main" class="mt-8 mx-5">
        ...
        <button id="createTask" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-11">
            Create new task
